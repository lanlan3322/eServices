...
<%
   ...
   String SQLCommand = SystemDOM.getDOMTableValueFor("releasepayments","listsql-my","");
   ...
   if (SQLCommand.equals("")) {
     ...
     SQLCommand += "WHERE RP_STAT = 'G3' AND REPORT.DEPART = 'ELCS' AND USER.CASH <> 'VERIFYING' AND USER.CASH <> 'HOLD'";
