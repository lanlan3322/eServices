    ...
    try {
     ...
     do { 
		...
		<tr>
			 ...
			 <td width="3%"  <%=backcolor%> align='left'><input type="checkbox" name="select_this_report" onclick="handleClick(this,<%=reportCount%>,<%=PersFile.getTrim(Reg.myResult.getString("EXPENSE.AMOUNT"))%>);"></input></td>
		 </tr>
...
<script type="text/javascript">
	function handleClick(cb,index,amount) {
		var gstRate = 1.07;
