...
<%
     ...
     PayeeSummary.setGeneralTitle("Individual Payments");
     PayeeSummary.setAccountTitle("Payee Total");
     ...
     String[] columnsWanted = {"RP_PERS_NUM","RP_VOUCHER","RP_NAME","RP_RE_AMT","REIMBURSE_CHECK","RP_UP_DATE","USER_CASH","USER_BANKCODE","USER_BANKACCT","RP_COMPANY"};
...
<%      newbackcolor = backcolor;
   ...
   try {
     do { 
        ...
        RP_COMPANY = RP_COMPANY.substring(1,RP_COMPANY.length()-1);
...
<%      
        ...
        PayeeSummary.add(RP_PERS_NUM,REIMBURSE_CHECK,RP_NAME);
        PaymentSummary.add(RP_COMPANY + "-" + USER_CASH,REIMBURSE_CHECK,"");
...
%>
  ...
  <br>
  <%= PayeeSummary.printGeneralSummary() %>
  <br>
  <br>
