...
%>
<form>
  <input type="hidden" name="xref" value><table border="0" cellpadding="0" cellspacing="0"  width="100%">
    ...
    <tr>
      ...
      height="240">
        <tr>
          ...
          onClick="setDateField(document.forms[0].begdate); top.newWin = window.open('/ess/calendar.html', 'cal', 'dependent=yes, width=210, height=230, screenX=200, screenY=300, titlebar=yes')"><img
          SRC="/ess/calendar.gif" BORDER="0" WIDTH="16" HEIGHT="16"></a><span class="ExpenseTinyLink">Popup
          Calendar</span></td>
        ...
        <tr>
          ...
          onClick="setDateField(document.forms[0].enddate); top.newWin = window.open('/ess/calendar.html', 'cal', 'dependent=yes, width=210, height=230, screenX=200, screenY=300, titlebar=yes')"><img
          SRC="/ess/calendar.gif" BORDER="0" WIDTH="16" HEIGHT="16"></a><span class="ExpenseTinyLink">Popup
          Calendar</span></td>
          <td width="35%"></td>
        </tr>
        <tr>
          <td width="25%" class="offsetColor" height="113"><div class="ExpenseTag"><p>Trip Purpose or
...
<p><strong  class="ExpenseTag">Enter purpose and then check the transactions that you wish to add to your expense report under this purpose.  When finished click on the button below.</strong></p>
...
<% String status; 
   ...
   try { %>
    ...
    <tr>
      <td width="5%" class="ExpenseTag"><strong>Add </strong></td>
      <td width="10%" class="ExpenseTag"><strong>Status</strong></td>
      <td width="14%" class="ExpenseTag"><strong>Card/Method</strong></td>
      <td width="13%" class="ExpenseTag"><strong>Date</strong></td>
      <td width="19%" class="ExpenseTag"><strong>Amount</strong></td>
      <td width="50%" class="ExpenseTag"><strong>Detail</strong></td>
    </tr>
<%    breakout = false;
      ...
      do { 
        ...
        reference = ensureSpace(status)+";"+cardtype + ";"+ Numbers[current_card].trim() + ";" + vendorReference + ";" + amount + ";" + commentInfo + ";" + recordCursor ; %>
          ...
          <td width="19%" <%=backcolor%>><%= amount %></td>
...
function SubmitRec() {
 if (dupFlagOK) {
  ...
  {   
    ...
    parent.contents.UpdateReport('1','head2j'); 
