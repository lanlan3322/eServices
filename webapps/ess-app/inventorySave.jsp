...
<%
   ...
   String subjectHR = "Inventory prepared (" + newAsOfDate + ") ";
   String msg3 = "New inventory requests are prepared!\n";
   ...
   /// Looping thru the tokens
		while (rp.hasMoreTokens() && actionFlag) {  
		 ...
		 if(action.equals("delivered")){
           ...
           SQLResult = Reg.doSQLExecute(SQLCommand);
Log.println("[500] inventorySave.jsp ln 353 - request processed: " + SQLCommand);
		...
		while (rp.hasMoreTokens() && actionFlag) {  
			...
			String sEmailMsg = "\n  Inventory Request Details:\n";
			String msg = "Your inventory request is prepared:\n";
