...
<%
   ...
   String SQLCommand = SystemDOM.getDOMTableValueFor("reporttable","selectaudit-my",""); 
   if (SQLCommand.equals("")) {
     ...
     SQLCommand += "WHERE RP_STAT = 'E2' AND DEPART = 'ELCS'";
...
%>
     ...
     <td width="25%" <%=backcolor%> align='left'><u><%= Lang.getString("paymentStat")%></u></td>
