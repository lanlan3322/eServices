...
<% try {
	...
	ex.printStackTrace();  
    Log.println("[500] UserListAdmin.jsp java.lang exception");
%>
...
<p align="right"><a class="ExpenseReturnLink" href="javascript: void parent.contents.TransWindow(parent.contents.defaultHead + 'head1c.html')" tabindex="2">Return to report header screen</a></p>
...
function x(AddValue) {
  ...
  if (parent.contents.setNameValue(parent.contents.Header, "persnum", AddValue[0][1]) &&
    ...
    parent.contents.TransWindow(parent.contents.defaultHead + 'head1c.html')
