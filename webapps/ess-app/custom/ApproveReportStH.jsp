...
***
<script language="javascript" id="script" folder="<%= PersFile.getAppServer() + "/" + PersFile.getAppFolder() %>" file="ajax/ApproveReportJS.jsp?reference=<%= reference%>&voucher=<%= voucher%>&status=<%= status%>&rcpt2=<%= rcpt2%>&reply2=<%= reply2%>&NeedPassword=<%= NeedPassword%>"/>
