...
%>
     ...
     <tr>
      <td width="5%" <%=backcolor%>><input type="checkbox" name="select_all_item" onclick="onCheckAll(this);">All</td>
     ...
     <td width="9%" <%=backcolor%> align='center'><u><%= Lang.getString("curDat")%></u></td>
     <td width="16%" <%=backcolor%> align='center'><u><%= Lang.getString("name")%></u></td>
     <td width="8%" <%=backcolor%> align='center'><u><%= Lang.getString("total")%></u></td>
     <td width="8%" <%=backcolor%> align='center'><u><%= Lang.getString("due")%></u></td>
     <td width="15%" <%=backcolor%> align='left'><u><%= Lang.getString("paymentStat")%></u></td>
     <td width="10%" <%=backcolor%> align='center'><u>Meal Date(if any)</u></td>
...
<% 
    ...
    try {
     do { 
		...
		//starting of getting dinner date
		String dinnerDate = "";
		...
		if (Reg2.setResultSet(SQLGetDinnerDate)) {
			try {
				do { 
					dinnerDate += PersFile.getTrim(Reg2.myResult.getString(1));
					dinnerDate += ";";
...
%>          
            ...
            <td width="9%" <%=backcolor%>><%= Dt.getUserDateStr(Dt.getSimpleDate(Dt.getDateFromXBase(curdate)),PersFile.getDateFormat())%></td>
            ...
            <td width="15%" <%=backcolor%>><%= Lang.getDataString(repDBStat)%></td>
            <td width="10%" <%=bgcolor%> align="center"><%= dinnerDate%></td>
...
%>
   ...
   <td width="100%" align="center">
     <input type="button" value="<%= Lang.getString("butReportOk")%>" name="B2" onClick="Javascript: void Approve()">
   </td>
   </tr> 
   </table>
</form>
