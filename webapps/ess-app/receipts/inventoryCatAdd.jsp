...
<p><u><em><strong><font face="Arial"><big>Create new category</big></font></strong></em></u></p>

<p><font face="Arial">Enter information about the new category and the image to upload.</font></p>
...
<form method="POST" action="" ENCTYPE="multipart/form-data" onSubmit="return checkInput()">
  ...
  <table border="0" cellpadding="10" cellspacing="10">
    <tr>
      ...
      <td width="85%" align="left"><input type="text" name="leaveReason" onBlur="setDatesBlank(document.forms[0].comments)"></td>
    </tr>
    <tr>
...
<p><u><em><strong><font face="Arial"><big>Category List:</big></font></strong></em></u></p>
<%
String SQLCommand = "SELECT * FROM db_category ORDER BY CAT_PHOTO DESC" + PersFile.getSQLTerminator();
...
<%
    ...
    try {
     do { 
		...
		total = PersFile.getTrim(Reg.myResult.getString(4));
		image = PersFile.getTrim(Reg.myResult.getString(5));
