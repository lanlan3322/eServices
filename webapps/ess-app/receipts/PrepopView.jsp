...
<%@ include file = "../../SystemInfo.jsp" %><%
  ...
  String okref =  request.getParameter("okref"); 


  String receiptNumberSQL = SysTable.getSystemString("receiptmanagement","getscanreffromokref","SELECT SCAN_REF FROM STATEMNT ON '$reference$' = XREF" + PersFile.getSQLTerminator());


  String receiptNumber =  request.getParameter("okref");
