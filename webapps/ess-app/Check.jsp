...
<% 
Log.println("[000] Check.jsp accessed by :" + PersFile.getName());
boolean pFlag = true;
if (pFlag) {
%>
...
<%
   ...
   if (param1 != null) {
      ...
      if (param2 != null) SQLCommand = Reg.SQLReplace(SQLCommand,"$param2$",Reg.repStr(param2));
      Log.println("[000] Check.jsp SQL:" + SQLCommand);
   } else {
      SQLCommand = null;
   }   
...
//Reg.myResult.getString(1)
   if (SQLCommand != null && Reg.setResultSet(SQLCommand)) { 
	   ...
	   Log.println("[000] Check.jsp result: " + retStr);
       out.println(retStr);
   } else { 
