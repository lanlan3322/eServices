...
<%=ESS.printTitle(Lang.getString("APP_REPORT"),PersFile.getCompanyName(),false) %>
</div>
...
<div id="approveSection" style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid">
    <form method="POST" accept-charset="ISO-8859-1" action="<%= PersFile.getAppServer() %>/<%= PersFile.getAppFolder() %>/ajax/ApproveSave.jsp">
    ...
    <div class="col1of2">
        ...
        <input class="actiontype" type="radio" value="assign" checked name="actiontype"><%= Lang.getString("re-assign") %><br />
        	<label for="department">Re-assign to: </label>
