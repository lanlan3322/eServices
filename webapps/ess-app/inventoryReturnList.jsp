...
<%
	...
	*/
	String SQLCommand = "SELECT * FROM DB_OPERATION WHERE OPERATION_STATUS = 'Signed' AND OPERATION_TYPE = 'Return' ORDER BY OPERATION_CREATED DESC;";
  ...
  %>
     ...
     <h1>Inventory Returns waiting for process:</h1><br>
<%   String persname;
...
<tr><td width="100%">
<form method="POST" action="<%= PersFile.getAppServer()%>/<%= PersFile.getAppFolder()%>/inventoryReturnSave.jsp">
...
%>
   ...
   <td width="100%" align="center">
     <input type="button" value="Checked returns are verified" name="B2" onClick="Javascript: void Approve()">
   </td>
   </tr> 
   </table>
</form>
