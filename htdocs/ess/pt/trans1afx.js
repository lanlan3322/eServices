...
function CheckComment(tag,expense) {
  return CheckRequired(tag,expense,parent.getCommentReq(),"Need to supply a comment in the comment field");
}

function CheckMerchant(tag,expense) {
  return CheckRequired(tag,expense,parent.getMerchantReq(),"Need to supply a merchant name in the merchant field");
}
