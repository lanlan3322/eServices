// addgeneral.js - source for adding merchants and single line popups to html pages
...
function setLocalObj(ThisObj, cType, defaultx, defaulty, cFolder) {
   if (cType == null) cType = "addmerchant";
   ...
   top.newWin = window.open(cFolder + cType + ".html", "merchant", optionString);
}
