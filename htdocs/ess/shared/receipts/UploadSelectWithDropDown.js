...
function initForm() {
	...
	Log.println("Receipt screen with: " + parent.myESSMenu.voucher, "initForm");
	displayScans();
}
...
function displayRemoveScans() {
  getRemoveFiles(document.forms[formStartNumber].pvoucher.options[document.forms[formStartNumber].pvoucher.selectedIndex].value);
}
function displayEmailScans() {
  getRemoveEmailFiles(document.forms[formStartNumber].pvoucher.options[document.forms[formStartNumber].pvoucher.selectedIndex].value);
}
...
function getRemoveFiles(x) {
   if (x == null) x = parent.myESSMenu.voucher;
