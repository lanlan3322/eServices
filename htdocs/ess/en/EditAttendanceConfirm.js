...
function Save() {
	if (saveXMLFile)
	{
	  ...
	  document.forms[formStartNumber].ccode.value = parent.CCode;
		...
		document.forms[formStartNumber].reference.value = parent.reference.value;
	  postSimpleForm(parent.defaultApps + 'ajax/AttendanceVOConfirm.jsp', document.forms[formStartNumber]); 
	}
}
